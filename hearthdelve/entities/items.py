...
CHARCOAL_TINCTURE= Item("Charcoal Tincture","!", "material", "Activated charcoal steeped in spirit — settles a sick stomach and purges a fever the salve can't touch.", value=250, heal=15, cures="sick")
...
GRAIN_MASH     = Item("Grain Mash",     "ū", "material", "Grain or potato fermented to a sour wash — distil it into spirit at the still.", value=110)
VODKA          = Item("Vodka",          "ø", "artisan",  "A clear spirit distilled from a grain mash — drunk, gifted, or the base of any strong tincture.", value=180, family="vodka")
...
# "Any fish" dishes — take whatever the creel holds, so no catch goes uncooked.
SASHIMI          = Item("Sashimi",          "≈", "food", "Fish sliced clean and raw, kissed with salt.", value=95, energy=55, buff="hearty")
SUSHI            = Item("Sushi",            "≈", "food", "Fish and seasoned rice, rolled by hand.", value=140, energy=70, buff="brisk")
FISH_CAKES       = Item("Fish Cakes",       "≈", "food", "Flaked fish bound with flour and egg, pan-fried.", value=160, energy=75, buff="hearty")
SEAFOOD_CHOWDER  = Item("Seafood Chowder",  "≈", "food", "A creamy chowder thick with the day's catch.", value=220, energy=95, buff="hearty")
# Signature dishes for the premium coop & dairy goods — a reason to keep a duck
# and a goat rather than sell their richer eggs and cheese outright.
QUICHE           = Item("Quiche",           "≈", "food", "A deep tart of rich duck egg and melted cheese.", value=480, energy=110, buff="hearty")
GOAT_CHEESE_TART = Item("Goat Cheese Tart", "≈", "food", "A savoury tart of tangy goat's cheese and tomato.", value=380, energy=95, buff="forager")
...
SMOKED_FISH = Item("Smoked Fish", "»", "artisan", "Fish slow-smoked to a delicacy.", value=200, energy=50, family="cured_fish")
...
EGG         = Item("Egg",         "○", "animal",   "A fresh-laid egg.",           value=35, energy=6, family="egg")
DUCK_EGG    = Item("Duck Egg",    "○", "animal",   "A big, rich duck egg.",       value=60, energy=12, family="egg")
MILK        = Item("Milk",        "◓", "animal",   "A pail of fresh milk.",       value=55, energy=10, family="milk")
GOAT_MILK   = Item("Goat's Milk", "◓", "animal",   "A pail of tangy goat's milk.", value=65, energy=10, family="milk")
TRUFFLE     = Item("Truffle",     "•", "animal",   "An earthy black truffle, rooted up by a pig — a chef's treasure.", value=280)
CHEESE      = Item("Cheese",      "◍", "artisan",  "A wheel of farmhouse cheese.", value=140, energy=32, family="cheese")
AGED_CHEESE = Item("Aged Cheese", "◍", "artisan",  "A cellar-aged wheel; sharp and crumbling.", value=210, energy=36, family="cheese")
GOAT_CHEESE = Item("Goat Cheese", "◍", "artisan",  "A soft, tangy round of goat's cheese.", value=170, energy=30, family="cheese")
AGED_GOAT_CHEESE = Item("Aged Goat Cheese", "◍", "artisan", "Cellar-aged goat's cheese; creamy heart, sharp rind.", value=255, energy=34, family="cheese")
...
# All share family="fish" so an "any fish" dish (see ANY_FISH) takes whatever
# the creel holds, and a villager who loves one fish loves the whole catch.
MINNOW      = Item("Minnow",      "»", "fish", "A tiny river fish.",           value=15, family="fish")
PERCH       = Item("Perch",       "»", "fish", "A common river catch.",        value=30, family="fish")
CARP        = Item("Carp",        "»", "fish", "A hefty, muddy carp.",         value=45, family="fish")
CATFISH     = Item("Catfish",     "»", "fish", "A rare whiskered giant.",      value=120, family="fish")
SMELT       = Item("Smelt",       "»", "fish", "Silvery spring shoal-fish.",   value=25, family="fish")
TROUT       = Item("Trout",       "»", "fish", "A fine spring/autumn trout.",  value=55, family="fish")
BREAM       = Item("Bream",       "»", "fish", "A flat, sunny-water fish.",    value=40, family="fish")
SUNFISH     = Item("Sunfish",     "»", "fish", "A summer sun-lover.",          value=30, family="fish")
PIKE        = Item("Pike",        "»", "fish", "A toothy summer predator.",    value=85, family="fish")
SALMON      = Item("Salmon",      "»", "fish", "Runs the rivers in autumn.",   value=95, family="fish")
ICEFISH     = Item("Icefish",     "»", "fish", "Caught through winter ice.",   value=45, family="fish")
STURGEON    = Item("Sturgeon",    "»", "fish", "A rare winter leviathan.",     value=160, family="fish")
# sea (cast from the coast / beaches)
SARDINE     = Item("Sardine",     "»", "fish", "A little silver shoaling sea fish.", value=30, family="fish")
MACKEREL    = Item("Mackerel",    "»", "fish", "A striped, oily sea fish.",       value=55, family="fish")
SEA_BASS    = Item("Sea Bass",    "»", "fish", "A prized coastal sea bass.",      value=110, family="fish")
TUNA        = Item("Tuna",        "»", "fish", "A big, prized deep-sea tuna.",    value=200, family="fish")
MOONFISH    = Item("Moonfish",    "»", "fish", "A pale deep-sea fish that rises only to the lighthouse beam.", value=420, family="fish")
# underground (dungeon lakes)
CAVE_BASS   = Item("Cave Bass",   "»", "fish", "Pale bass from lightless pools.", value=60, family="fish")
EEL         = Item("Eel",         "»", "fish", "A slippery cave eel.",           value=70, family="fish")
BLINDFISH   = Item("Blindfish",   "»", "fish", "Eyeless and ghostly.",           value=45, family="fish")
GLOWFISH    = Item("Glowfish",    "»", "fish", "Faintly luminescent; prized.",   value=180, family="fish")
